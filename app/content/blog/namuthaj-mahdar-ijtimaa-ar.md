...
![مقارنة بين محضر اجتماع رسمي كامل ومحضر اجتماع قصير وسهل](/blog/namuthaj-mahdar-ijtimaa-ar/short-vs-full-template.webp)
*يسار: المحضر الرسمي الكامل — تنسيق ثابت وتوثيق تصويت. يمين: المحضر القصير — أساسيات فقط: القرار، المسؤول، الموعد.*
...
## الفرق بين محضر اجتماع رسمي ونموذج جاهز للتحميل

يبحث كثيرون عن "نموذج محضر اجتماع رسمي" ظنّاً منهم أنه نوعٌ مختلفٌ عن النموذج الجاهز أعلاه — والحقيقة أنهما غالباً الوثيقة نفسها بدرجتي استخدامٍ مختلفتين. المحضر الرسمي هو الذي سيُحفظ في سجلّ الجهة ويُوقَّع ويُعتمد كمرجعٍ يصمد أمام مدقّقٍ خارجي أو جهةٍ رقابية بعد أشهر: اجتماعات مجلس الإدارة، اللجان النظامية، الجمعيات العمومية، أو أي اجتماعٍ يحتاج توثيقاً رسمياً. النموذج الجاهز الذي حمّلته أعلاه (.docx) يخدم كلا الاستخدامين بنفس الهيكل الأساسي؛ الفرق الوحيد أن الصيغة الرسمية تحتاج حقولاً إضافية لا يحتاجها اجتماع فريقٍ داخلي: رقم الجلسة وتسلسلها، توقيعات الحاضرين، وتوثيق النصاب القانوني إن كان الاجتماع يتطلبه. أضِف هذه الحقول إلى النموذج قبل الطباعة إذا كان محضرك سيُرفَع لجهةٍ خارجية أو سيُحفَظ في ملفٍّ رسمي؛ أما إن كان لمتابعةٍ داخلية فقط، فالنموذج كما هو يكفي.
...
### هل يصلح هذا النموذج لمحضر اجتماع مجلس الإدارة أو اللجان؟
نعم، بنفس الهيكل الأساسي مع إضافاتٍ قليلة. مجالس الإدارة واللجان النظامية (كلجنة التدقيق ولجنة الترشيحات) تحتاج حقولاً لا يحتاجها اجتماع الفريق العادي: رقم الجلسة وتسلسلها، صفة الحضور (أصالةً عن نفسه أم إنابةً عن عضوٍ آخر)، النصاب القانوني اللازم لصحة الانعقاد، وتوثيق التصويت — هل كان القرار بالإجماع أم بالأغلبية، ومن سجّل تحفّظه إن وُجد. أضف هذه الحقول إلى النموذج الجاهز أعلاه قبل استخدامه في اجتماع مجلس إدارة أو لجنة، والتزم بترقيم الجلسات تسلسلياً (اجتماع رقم كذا، بتاريخ كذا) لأن هذا الترقيم هو ما يربط محاضر الجلسات المتعاقبة ببعضها عند المراجعة أو التدقيق.
