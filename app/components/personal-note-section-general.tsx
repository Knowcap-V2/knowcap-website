    ...
    <section className="py-20 md:py-28 relative overflow-hidden bg-gradient-to-br from-[#18181B] to-[#0A0A0A]">
      ...
      <div className="max-w-[700px] mx-auto px-8 text-center relative z-10">
        ...
        >
          ...
          <p className="text-[15px] text-white/40 mb-10 max-w-[500px] mx-auto" style={{ fontFamily: "'Inter', sans-serif", lineHeight: 1.7 }}>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-center">
            <a
              ...
              className="inline-flex items-center gap-2 px-7 py-3 bg-white text-[#0A0A0A] font-medium text-[14px] rounded-lg hover:bg-white/90 transition-colors"
            ...
            <a
              href="/book"
              className="inline-flex items-center gap-2 px-7 py-3 border border-white/[0.12] text-white/60 font-medium text-[14px] rounded-lg hover:border-white/[0.2] hover:text-white transition-colors"
              style={{ fontFamily: "'Inter', sans-serif" }}
            >
              Book a Demo
            </a>
