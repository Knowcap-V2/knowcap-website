    ...
    <>
      ...
      <EditorialShell>
        <PageHero
          ...
          sub={`${COMPETITOR} gives you a meeting agenda, transcript, and AI summary. Knowcap captures the meeting — and the WhatsApp call, the voice note, the in-person room — extracts every decision / risk / task, lets a human confirm, then triggers agents that ship real work.`}
        />
