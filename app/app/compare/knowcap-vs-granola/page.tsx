    ...
    <>
      ...
      <EditorialShell>
        <PageHero
          ...
          sub={`${COMPETITOR} gives you a beautiful AI note from a desktop video call. Knowcap captures the meeting — and the in-person room, the WhatsApp call, the voice note — extracts every decision / risk / task, lets a human confirm, then triggers agents that ship real work.`}
        />
        <div className="cl-page-body">
          <div className="cl-wrap">
            ...
            <div className="cm-section" id="compare">
              ...
              <p className="cm-lead">Where {COMPETITOR} ends at a clean desktop note, Knowcap continues — capturing mobile + WhatsApp + in-person calls, verifying each claim, and acting on the confirmed ones.</p>
