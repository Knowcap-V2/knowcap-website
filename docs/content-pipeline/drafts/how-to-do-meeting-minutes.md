...
1. **Before — build the skeleton from the agenda.** Open your template and pre-fill the header, the attendee list, and one heading per agenda item. Now you are filling a structure, not writing from a blank page.
2. **During — capture decisions and actions, not sentences.** For each agenda item, write only what was decided and what was assigned. Use a consistent action-item format: *task — owner — deadline*. Do not transcribe; you will lose the decision while typing the discussion.
3. **During — flag risks and open items as you go.** When something is raised but not resolved, drop it under "open items" immediately so it is not forgotten.
4. **After — format within 24 hours.** Memory fades fast; the same-day write-up is always more accurate. Turn your rough capture into the clean 7-element format above.
5. **After — verify the decisions against what was actually said.** This is the step everyone skips and the one that matters most. Confirm each decision and action against the recording or your notes before you send. An unverified minute is just a guess with a letterhead.
6. **Distribute — send promptly for approval.** Send within a day, ask the chair or client to approve, and note any correction. Approval is what turns a draft into the record.
7. **Store — keep the minutes findable and dated.** A minute you cannot retrieve in a dispute is a minute you do not have. Keep them in one place, searchable, with the source recording linked.

## Free meeting minutes template (copy-paste)

Copy this into your notes app or document. It works for a board meeting, a client call, or an internal stand-up.

```
MEETING MINUTES
Title:        ____________________________
Date / time:  ____________  ____:____ to ____:____
Location:     ____________________________ (room / video link)
Chair:        ____________________________
Minute-taker: ____________________________

ATTENDEES
Present:   ____________________________
Apologies: ____________________________

AGENDA + DISCUSSION
1. [Topic] — one-line summary of what was discussed
2. [Topic] — ...
...
- ____________________________ — ______ — __/__/____
- ...
...
Good minutes are short, decision-first, and confirmed by a named human — not a transcript and not an unchecked AI summary. If you want every decision in your minutes cited to the moment it was said and confirmed by a real person before it counts, [try Knowcap free](https://app.knowcap.ai/register) and run your next meeting through it.
